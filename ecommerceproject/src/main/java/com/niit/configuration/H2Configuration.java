...
public class H2Configuration {
	...
	public SessionFactory sessionFactory() {
		...
		Class classes[]=new Class[]{Product.class,Category.class,User.class,Authorities.class,Customer.class,BillingAddress.class,ShippingAddress.class,CartItem.class}; //If product class is not yet created, remove this and add it later
